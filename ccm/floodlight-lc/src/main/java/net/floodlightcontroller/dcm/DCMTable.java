...
public class DCMTable extends ServerResource {
    protected static Logger log = LoggerFactory.getLogger(DCMTable.class);
    ...
    public Map<String, List<Map<String, Object>>> getSwitchTableJson() {
        IDCMService lsp = 
                (IDCMService)getContext().getAttributes().
                    get(IDCMService.class.getCanonicalName());
